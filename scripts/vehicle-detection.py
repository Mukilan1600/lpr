...
if __name__ == '__main__':
	...
	try:
		...
		vehicle_net  = dn.load_net(vehicle_netcfg.encode("ascii"), vehicle_weights.encode("ascii"), 0)
		...
		for i,img_path in enumerate(imgs_paths):
			...
			R = detect(vehicle_net, vehicle_meta, img_path.encode("ascii") ,thresh=vehicle_threshold)
			print(R)
